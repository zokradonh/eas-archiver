...
internal static class EasWbxml
{
    ...
    static EasWbxml()
    {
        var defs = new (string ns, string name, byte page, byte tok)[]
        {
            ...
            (NsAirSync, "CollectionId",      0, 0x11),
            (NsAirSync, "GetChanges",        0, 0x12),
            (NsAirSync, "MoreAvailable",     0, 0x13),
            (NsAirSync, "WindowSize",        0, 0x14),
            (NsAirSync, "Commands",          0, 0x15),
            (NsAirSync, "Options",           0, 0x16),
            (NsAirSync, "FilterType",        0, 0x17),
            (NsAirSync, "Truncation",        0, 0x18),
            (NsAirSync, "RtfTruncation",     0, 0x19),
            (NsAirSync, "Conflict",          0, 0x1A),
            (NsAirSync, "Collections",       0, 0x1B),
            (NsAirSync, "ApplicationData",   0, 0x1C),
            (NsAirSync, "DeletesAsMoves",    0, 0x1D),
            (NsAirSync, "NotifyGUID",        0, 0x1E),
            (NsAirSync, "Supported",         0, 0x1F),
            (NsAirSync, "SoftDelete",        0, 0x20),
            (NsAirSync, "MIMESupport",       0, 0x21),
            (NsAirSync, "MIMETruncation",    0, 0x22),
            (NsAirSync, "Wait",              0, 0x23),
            (NsAirSync, "Limit",             0, 0x24),
            (NsAirSync, "Partial",           0, 0x25),
            (NsAirSync, "ConversationMode",  0, 0x26),
            (NsAirSync, "MaxItems",          0, 0x27),
            (NsAirSync, "HeartbeatInterval", 0, 0x28),
